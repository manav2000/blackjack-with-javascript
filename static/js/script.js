...
function blackjackDeal() {
    if (blackjackGame['turnsOver'] === true) {
        ...
        let yourImages = document.querySelector(YOU['div']).
        querySelectorAll('img');
        let dealerImages = document.querySelector(DEALER['div']).
        querySelectorAll('img');
...
function computeWinner() {
    ...
    if (YOU['score'] <= 21) {
        //condition: higher score than dealer or when dealer bust's but ur 21 or under
